...
# DVE full session
# Saved on Mon May 2 23:51:14 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1463 823}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 277} {height 524} {dock_state left} {dock_on_new_line true} {child_hier_colhier 169} {child_hier_coltype 107} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 427} {height 524} {dock_state left} {dock_on_new_line true} {child_data_colvariable 189} {child_data_colvalue 149} {child_data_coltype 89} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1455} {height 169} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_source -id ${Source.1}  -replace -active bk_adder_32_tb /afs/ee.ust.hk/staff/ee/cmfanab/vlsi_project/assignment1/syn_sim/../tb/bk_adder_32_tb.v
